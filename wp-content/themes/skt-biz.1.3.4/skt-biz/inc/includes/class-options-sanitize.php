...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'skt-biz' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'skt-biz' ),
		'repeat-y'  => __( 'Repeat Vertically', 'skt-biz' ),
		'repeat'    => __( 'Repeat All', 'skt-biz' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'skt-biz' ),
		'top center'    => __( 'Top Center', 'skt-biz' ),
		'top right'     => __( 'Top Right', 'skt-biz' ),
		'center left'   => __( 'Middle Left', 'skt-biz' ),
		'center center' => __( 'Middle Center', 'skt-biz' ),
		'center right'  => __( 'Middle Right', 'skt-biz' ),
		'bottom left'   => __( 'Bottom Left', 'skt-biz' ),
		'bottom center' => __( 'Bottom Center', 'skt-biz' ),
		'bottom right'  => __( 'Bottom Right', 'skt-biz')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'skt-biz' ),
		'fixed'  => __( 'Fixed in Place', 'skt-biz')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'skt-biz' ),
		'italic'      => __( 'Italic', 'skt-biz' ),
		'bold'        => __( 'Bold', 'skt-biz' ),
		'bold italic' => __( 'Bold Italic', 'skt-biz' )
		);
