 ...
 *
 * If you are making your theme translatable, you should replace 'skt-biz'
...
function optionsframework_options() {
	...
	$section_text = array(
		1 => array(
			...
			'bgimage'		=> '',
			'class'			=> 'welcome_text',
			'content'		=> '<div class="icon_column">
					<h4 class="icon-box-title">Lorem ipsum dolor sit</h4>
					Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer elementum justo eu tincidunt sollicitudin. Morbi vel nulla maximus, ullamcorper lorem eu.</div>
					<div class="icon_column">
					<h4 class="icon-box-title">Lorem ipsum dolor sit</h4>
					Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer elementum justo eu tincidunt sollicitudin. Morbi vel nulla maximus, ullamcorper lorem eu.</div><div class="icon_column last">
					<h4 class="icon-box-title">Lorem ipsum dolor sit</h4>
					Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer elementum justo eu tincidunt sollicitudin. Morbi vel nulla maximus, ullamcorper lorem eu.</div>'
		),
		
		2 => array(
			'section_title'	=> 'SKTBIZ Wordpress Theme',
			'bgcolor' 		=> '#f5f5f5',
			'bgimage'		=> '',
			'class'			=> 'about_text',
			'content'		=> 'Lorem ipsum dolor sit amet, consectetur adipiscing elit Integer elementum 
amet justo tincidunt vehicula eros a dictum nunc Phasellus aliquet ex nec mauris commodo
			<img src="'.get_template_directory_uri().'/images/welcome-image-new.png" />'
		),
		...
		5 => array(
			...
			'bgimage'		=> '',
			'class'			=> 'clients',
			'content'		=> '<h2 class="client-title">Our Clients</h2>
			<img src="'.get_template_directory_uri().'/images/wp-logo.png"><img src="'.get_template_directory_uri().'/images/woo-logo.png"><img class="/" src="'.get_template_directory_uri().'/images/jQuery-logo.png"><img class="yes" src="'.get_template_directory_uri().'/images/bb-logo.png">'
		),
	);
	...
	//Basic Settings
	$options[] = array(
		'name' => __('Basic Settings', 'skt-biz'),
		'type' => 'heading');

	$options[] = array(
		'name' => __('Logo', 'skt-biz'),
		'desc' => __('Upload your main logo here', 'skt-biz'),
		'id' => 'logo',
		'class' => '',
		'std'	=> '',
		'type' => 'upload');
	...
	$options[] = array(
		'name' => __('Favicon', 'skt-biz'),
		'desc' => __('Upload favicon for website', 'skt-biz'),
		'id' => 'favicon',
		'class' => '',
		'std'	=> '',
		'type' => 'upload');
	...
	$options[] = array(
		'name' => __('Footer Left Copyright Text', 'skt-biz'),
		'desc' => __('Some text for footer of your site, you would like to display in the footer.', 'skt-biz'),
		'id' => 'footertext',
		'std' => 'Copyright &copy; 2014 SKT-Biz. Theme by <a href="'.SKT_THEME_URL.'" target="_blank">SKT Themes</a>.',
		'type' => 'textarea');

	$options[] = array(
		'name' => __('Footer Right Links / Text', 'skt-biz'),
		'desc' => __('Some text for footer of your site, you would like to display in the footer.', 'skt-biz'),
		'id' => 'footerlinks',
	...
	$options[] = array(
		'name' => __('Custom CSS', 'skt-biz'),
		'desc' => __('Some Custom Styling for your site. Place any css codes here instead of the style.css file.', 'skt-biz'),
		'id' => 'style2',
		'std' => '',
		'type' => 'textarea');
	...
	//Layout Settings
	$options[] = array(
		'name' => __('Sections', 'skt-biz'),
		'type' => 'heading');

	$options[] = array(
		'name' => __('Number of Sections', 'skt-biz'),
		'desc' => __('Select number of sections', 'skt-biz'),
		'id' => 'numsection',
		'type' => 'select',
		'std' => '5',
	...
	for( $n=1; $n<=$numsecs; $n++){
		$options[] = array(
			'desc' => __("<h3>Section</h3>", 'skt-biz'),
			'class' => 'toggle_title',
			'type' => 'info');	
	
		$options[] = array(
			'name' => __('Section Title', 'skt-biz'),
			'id' => 'sectiontitle'.$n,
			'std' => ( ( isset($section_text[$n]['section_title']) ) ? $section_text[$n]['section_title'] : '' ),
			'type' => 'text');

		$options[] = array(
			'name' => __('Section Background Color', 'skt-biz'),
			'desc' => __('Select background color for section', 'skt-biz'),
			'id' => 'sectionbgcolor'.$n,
			'std' => ( ( isset($section_text[$n]['bgcolor']) ) ? $section_text[$n]['bgcolor'] : '' ),
			'type' => 'color');

		$options[] = array(
			'name' => __('Section CSS Class', 'skt-biz'),
			'desc' => __('Set class for this section.', 'skt-biz'),
			'id' => 'sectionclass'.$n,
			'std' => ( ( isset($section_text[$n]['class']) ) ? $section_text[$n]['class'] : '' ),
			'type' => 'text');

		$options[] = array(
			'name' => __('Section Content', 'skt-biz'),
			'id' => 'sectioncontent'.$n,
	...
	//SLIDER SETTINGS
	$options[] = array(
		'name' => __('Slider Images', 'skt-biz'),
		'type' => 'heading');
		
	$options[] = array(
		'name' => __('Inner Page Slider', 'skt-biz'),
		'desc' => __('Show / Hide inner page slider', 'skt-biz'),
		'id' => 'innerpageslider',
		'type' => 'select',
		'std' => 'hide',
	...
	$options[] = array(
		'name' => __('Slider Image 1', 'skt-biz'),
		'desc' => __('Upload / select image for slide 1', 'skt-biz'),
		'id' => 'slide1',
		'class' => '',
	...
	$options[] = array(
		'desc' => __('Title 1', 'skt-biz'),
		'id' => 'slidetitle1',
		'std' => 'Free Business WordPress Theme',
		'type' => 'text');

	$options[] = array(
		'desc' => __('Slide Descrition 1', 'skt-biz'),
		'id' => 'slidedesc1',
	...
	$options[] = array(
		'name' => __('Slider Image 2', 'skt-biz'),
		'desc' => __('Upload / select image for slide 2', 'skt-biz'),
		'id' => 'slide2',
		'class' => '',
	...
	$options[] = array(
		'desc' => __('Title 2', 'skt-biz'),
		'id' => 'slidetitle2',
		'std' => 'Fully Responsive WordPress Theme',
		'type' => 'text');

	$options[] = array(
		'desc' => __('Slide Descrition 2', 'skt-biz'),
		'id' => 'slidedesc2',
	...
	$options[] = array(
		'name' => __('Slider Image 3', 'skt-biz'),
		'desc' => __('Upload / select image for slide 3', 'skt-biz'),
		'id' => 'slide3',
		'class' => '',
	...
	$options[] = array(
		'desc' => __('Title 3', 'skt-biz'),
		'id' => 'slidetitle3',
		'std' => 'Easy to Use',
		'type' => 'text');

	$options[] = array(
		'desc' => __('Slide Descrition 3', 'skt-biz'),
		'id' => 'slidedesc3',
	...
	// Support					
	$options[] = array(
		'name' => __('Our Themes', 'skt-biz'),
		'type' => 'heading');

	$options[] = array(
		'desc' => __('SKT Biz WordPress theme has been Designed and Created by SKT Themes.', 'skt-biz'),
		'type' => 'info');	

	 $options[] = array(
		'desc' =>'<a href="'.esc_url(SKT_URL).'" target="_blank"><img src="'.get_template_directory_uri().'/images/sktskill.jpg"></a><p><em><a target="_blank" href="'.esc_url(SKT_THEME_URL_DIRECT).'">'.__('Buy PRO version for only $39 with more features.','skt-biz').'</a></em></p>',
		'type' => 'info');	
