...
<img src="http://localhost/wordpress-4.9.6/wordpress/wp-content/uploads/2018/09/风景切-2.jpg" style="width:auto;height:auto;position:relative">
	...
	<header id="masthead" class="site-header" role="banner" >
		<div class="site-branding container">
			<div class="row">
				<div class="col-md-12 header-logo">
					<div class="container">
						<?php
      $image = wp_get_attachment_image_src(388, 'full'); ?>
      ...
      ?>
                    ...
                    <div class="col-md-2" style="margin-right:-50px">
                      <img src="http://localhost/wordpress-4.9.6/wordpress/wp-admin/images/ncnu_LOGO.jpg" style="height:100px;width:100px">
                    </div>
                    <div class="col-md-10">
                      <div class="row" style="font-size:30px">國立暨南國際大學</div>
                      <!-- <p class="small-title" style="font-size:30px;color:black;margin-bottom:20px;font-weight:bold"></p> -->
                      <div class="row">環境保護暨安全衛生中心</div>
                    </div>
                  </a>
							<?php endif; ?>
							<?php
